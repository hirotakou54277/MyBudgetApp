...
データ収集と入力
    ...
    収入、支出、現在の残金、貯金設定の入力フォーム
        ＋ボタンやカレンダーを押して金額の項目と金額と日時を追加可能

データの表示と管理

    タブで収入、支出、現在の残金、AI貯金設定、AI予測の使える金額を切り替えて表示
    タイムスタンプ付きで自動収入と支出の記録

AI予測

    毎日、毎週、毎月の金銭状況の推移のAI予測を3か月先までをグラフで可視化
    運用額の推移をAI予測をグラフで可視化
    残金と貯金設定に基づくAIによる目標使用額の提案

貯金設定

    貯金したい目標金額とカレンダーで目標期日を入力し、それに基づいて使える金額をAIが運用額の推移から毎日、毎週、毎月の使える金額を調整
    ＋ボタンを押して貯金項目を追加可能
...
日々の利用
    ...
    支出や残金の変動が発生した際に、その都度＋ボタンで収入や支出項目を追加して金額を入力
    支出や収入のデータは自動でタイムスタンプ付きで記録

AI予測と管理

    AIが入力されたデータを基に今後の金銭状況を予測し、グラフで表示
    毎日、毎週、毎月の使える金額やAI貯金で設定した目標金額と期日までに今の金銭の運用額の推移から何日までに貯まるかを予測をリアルタイムで更新

レポート作成

    必要に応じて、各タブの内容をPDFで保存または印刷し、金銭管理の情報を共有可能

トップページ

トップページにはシンプルに6つのボタンを配置し、各ボタンをタップすると対応する詳細画面が開きます。
